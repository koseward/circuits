...
public class GraphingMain
{
   ...
   final static int
      MIN_VERTICES = 7, VERTEX_RANGE = 0, MAX_VERTEX_WEIGHT = 999;
   ...
   /**
    * Is run for the creation of one graph, for use with a dumby user
    * <p>
    * Note: Is used to show off the power of the program, as this one has 
    * siginificantly more output
    */
